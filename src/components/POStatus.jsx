...
//     const groupedArray = Object.entries(groups).map(([groupKey, groupRows]) => {
//       return {
//         groupKey,
//         rows:
//           remainingKeys.length > 0
//             ? groupData(groupRows, remainingKeys)
//             : groupRows,
//         totals: calculateTotals(groupRows),
//       };
//     });
    ...
    return (
      <React.Fragment key={label + idx}>
        <tr className="bg-gray-200 font-bold">
          ...
          <td className="border px-4 py-2 font" colSpan={4}>
            {group.path
              .map(
                (p) =>
                  `${
