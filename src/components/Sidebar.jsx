...
// import React, { useState, useEffect } from "react";
// import { Link, useLocation, useNavigate } from "react-router-dom";
// import { Menu, Clock, Users, Layers, Download, CheckSquare, ChevronLeft, ChevronRight, GitBranch, Briefcase, FileText } from "lucide-react";
...
//                 <div className="flex-grow">
//                     {/* Timesheet: Show for Admin and User and PM */}
//                     {(isAdmin || isUser || isPM) && (
//                         <SidebarItem icon={<Clock className="h-5 w-5" />} text="Timesheet" to="/dashboard/timesheet" selectedPage={pathname} handleLinkClick={handleLinkClick} isCollapsed={isCollapsed} />
//                     )}
...
//                     {/* Revision: Show for PM only */}
//                     {/* {isPM && (
//                         <SidebarItem icon={<GitBranch className="h-5 w-5" />} text="Revision" to="/dashboard/revision" selectedPage={pathname} handleLinkClick={handleLinkClick} isCollapsed={isCollapsed} />
//                     )} */}
                    
//                     {/* Print Invoice: Show for PM only */}
//                     {/* {isPM && (
//                         <SidebarItem icon={<FileText className="h-5 w-5" />} text="Print Invoice" to="/dashboard/print-invoice" selectedPage={pathname} handleLinkClick={handleLinkClick} isCollapsed={isCollapsed} />
//                     )} */}
...
// import React, { useState, useEffect } from "react";
// import { Link, useLocation, useNavigate } from "react-router-dom";
// import { Menu, Clock, Users, Layers, Download, CheckSquare, ChevronLeft, ChevronRight, GitBranch, Briefcase, FileText, ClipboardCheck, UserCheck, Shield } from "lucide-react";
...
//                     {/* Approval: Show for Admin and PM only - FIXED LARGE ICON */}
//                     {(isAdmin || isPM) && (
//                         <SidebarItem 
//                             icon={
...
import React, { useState, useEffect } from "react";
import { Link, useLocation, useNavigate } from "react-router-dom";
import { Menu, Clock, Users, Layers, Download, CheckSquare, ChevronLeft, ChevronRight, GitBranch, Briefcase, FileText, ClipboardCheck, UserCheck, Shield, Receipt } from "lucide-react";
