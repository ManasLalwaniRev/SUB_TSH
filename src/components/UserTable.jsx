...
// //                   className="bg-green-500 text-white font-bold py-2 px-5 rounded-lg hover:bg-green-600 transition-colors flex items-center gap-2 shadow-lg hover:shadow-green-500/50"
// //                 >
...
export default function UserTable() {
  ...
  // };
  const getInitials = (name) => {
    // Defensive: cover null, undefined, and non-string values
  ...
  if (isAdmin) {
    ...
    return (
      <>
        ...
        <div className="h-screen bg-[#ffffff] flex flex-col pr-4 overflow-hidden">
          <div className="flex-1 flex flex-col pt-6 pb-6">
            ...
            <div className="w-full bg-white p-2 ml-3 rounded-lg shadow border border-gray-200 mb-1 flex items-center justify-end gap-3">
              <div className="flex items-center gap-4">
                {/* <h1 className="text-4xl font-bold text-gray-800">
              User Management
            </h1> */}
            ...
            {/* <div className="min-h-screen bg-slate-50 flex flex-col ml-4 pr-8 py-8">
              <div className="flex-1 flex flex-col">
                <div className="border border-gray-300 rounded-2xl bg-white shadow-md p-2 w-full max-w-[calc(100vw-220px)] mx-auto"> */}
            <div className="border ml-3 border-gray-300 rounded-2xl bg-white shadow-md p-2 w-full  mx-auto">
              <div
                className="overflow-x-auto overflow-y-auto w-full"
                style={{ maxHeight: "75vh" }}
              >
