...
//             setIsLoading(true);
//             const API_URL = `https://timesheet-subk-latest.onrender.com/api/PurchaseOrders/ByResourceDetails/${resourceId}`;
//             try {
...
//         const API_URL = "https://timesheet-subk-latest.onrender.com/api/SubkTimesheet";
...
//             // UPDATED: Filter timesheetHours to only include modified entries in edit mode
...
//                         Ts_Date: dateForApi,
//                         Hours: line.hours[day] || 0,
//                         day: day  // Temporary property for filtering
//                     };
//                 })
//                 .filter(hourEntry => {
//                     // In edit mode, only include modified hours
//                     if (isEditMode) {
//                         return modifiedHours.has(`${line.id}-${hourEntry.day}`);
//                     }
//                     // In create mode, include all non-zero hours
//                     return hourEntry.Hours > 0;
//                 })
//                 .map(({ day, ...rest }) => rest);  // Remove temporary 'day' property
...
//         showToast(`Timesheet ${isEditMode ? 'updated' : 'created'} successfully!`, 'success');
//         setModifiedHours(new Set()); // ADDED: Reset modified hours tracking
//         onClose();
//     } catch (error) {
//         showToast(error.message, 'error');
//         setIsSubmitting(false);
...
//     return (
//         // CHANGED: Removed modal overlay, using inline container instead
