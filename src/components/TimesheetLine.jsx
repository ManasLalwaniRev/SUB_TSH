    ...
    const handleSubmit = async () => {
        ...
        for (const line of linesToSubmit) {
            ...
            const payload = {
                ...
                createdAt: isEditMode ? timesheetToEdit.createdAt : now,
                createdBy: isEditMode ? timesheetToEdit.createdBy : String(resourceId),
                status: isEditMode ? timesheetToEdit.status : "OPEN",
                approvalStatus: isEditMode ? timesheetToEdit.approvalStatus : "PENDING",
            };
            ...
            try {
                ...
                showToast(`Error submitting line ${line.id}: ${error.message}`, 'error');
                return;
            }
        }
        
        showToast(isEditMode ? 'Timesheet updated successfully!' : 'Timesheets submitted successfully!', 'success');
        onClose();
    };
