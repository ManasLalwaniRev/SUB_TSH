...
// --- ADDED: MinusCircleIcon for column hide action ---
                ...
                <tr>
                  {tableHeaders.map((header, index) => {
                    ...
                    return (
                      ...
                      >
                        {/* WRAPPED content in 'group' div to enable hover effect on button */}
                        <div className="flex items-center justify-between gap-2 group">
                          ...
                          {isHideable && (
                            <button
                              ...
                              // Applied opacity and group-hover classes
                              className="p-1 hover:bg-gray-200 rounded-full transition-colors opacity-0 group-hover:opacity-100"
                              title="Hide column"
                              type="button"
                            >
                              <MinusCircleIcon className="h-3.5 w-3.5 text-gray-400 hover:text-gray-600" />
                            </button>
                          )}
                        </div>
                      </th>
